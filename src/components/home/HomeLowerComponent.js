...
function HomeLowerComponent({ userObj, todayTargets }) {
          ...
          <>
            {todayTargets.map((target, index) => (
              <TodoBox key={index}>
                ...
                <Todo
                  style={{
                    color: target.isComplished ? "yellow" : null,
                    textDecorationLine: target.isComplished
                      ? "line-through"
                      : null,
                  }}
                  htmlFor={target.id}
